...
if (runMC):
   ...
   #	'file:/nfs/data36/cms/ulmerk/CMSSW_4_1_5/src/EC43622A-746F-E011-8800-0018F3D09664.root'
   # one file from /RelValJpsiMM/CMSSW_4_2_2-START42_V11-v1/GEN-SIM-RECO
        'file:/nfs/data36/cms/ulmerk/test_temp/CMSSW_4_2_2/src/109D8F99-B16D-E011-A69A-0018F3D0968C.root'
	)
   )
...
if (runMC):
   process.schedule = cms.Schedule(process.pat, process.trigMatchPath )
else:
   process.schedule = cms.Schedule(process.pat, process.trigMatchPath )
